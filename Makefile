...
GOBUILD=CGO_ENABLED=0 go build -tags with_gvisor -trimpath -ldflags '-X "github.com/c83a/Clash.Meta/constant.Version=$(VERSION)" \
		-X "github.com/c83a/Clash.Meta/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
